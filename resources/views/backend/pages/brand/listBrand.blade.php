                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{url('images')}}/brands/{{$value->logo}}" alt="" width="50%"></td>
                                    <td style="padding-top: 25px">{{($value->status == 1)? 'Show' : 'Hidden'}}</td>
                                    <td style="padding-top: 25px">
                                    <span style="display: flex;" class="reason">
                                        <a href="{{route('brand.edit',$value->id)}}" title="Edit"><i class="fas fa-edit" style="padding-right: 10px;color: green"></i></a>
