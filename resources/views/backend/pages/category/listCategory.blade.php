                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{($value->parent_id == 0)? 'Big Catelog' : 'Small Catelog'}}</td>
                                    <td>
                                    <span style="display: flex;" class="reason">
                                        <a href="{{route('category.edit',$value->id)}}" title="Edit"><i class="fas fa-edit" style="padding-right: 10px;color: green"></i></a>
